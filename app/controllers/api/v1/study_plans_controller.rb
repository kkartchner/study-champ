class Api::V1::StudyPlansController < ApplicationController
  def index
  ...
  def create
    ...
    if study_plan.save
      ...
      render json: { status: 'ERROR', message: 'Study plan not saved', data: study_plan },
